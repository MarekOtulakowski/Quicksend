export const STRINGS = {
  pl: {
    ...
    appTagline: "Wyślij plik na inne urządzenie w kilka sekund.",
    startReceive: "📥 Odbierz",
    startSend: "📤 Wyślij",
    remoteCodeLink: "Zdalnie? Sparuj kodem zamiast QR",
    codeRoleChooseTitle: "Parowanie zdalne kodem",
    roleReceive: "Odbierz",
    roleSend: "Wyślij",
    backButton: "Wstecz",
    ...
    pasteLinkInsteadButton: "Nie możesz zeskanować? Wklej link ręcznie",
  ...
  en: {
    ...
    appTagline: "Send a file to another device in seconds.",
    startReceive: "📥 Receive",
    startSend: "📤 Send",
    remoteCodeLink: "Remote? Pair with a code instead of QR",
    codeRoleChooseTitle: "Remote pairing by code",
    roleReceive: "Receive",
    roleSend: "Send",
    backButton: "Back",
    ...
    pasteLinkInsteadButton: "Can't scan? Paste link manually",
